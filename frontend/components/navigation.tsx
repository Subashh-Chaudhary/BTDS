      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-foreground hidden sm:inline">BrainDetect</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {!mounted || !initialized || !isAuthenticated || !user ? (
              <>
                ...
                <Link href="/auth/register" className="px-6 py-2 rounded-full bg-primary text-white text-sm font-medium hover:bg-primary/90 transition">
                  Register
                </Link>
              </>
            ) : (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onSelect={() => { logout(); router.push('/'); }}>Logout</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            )}
          </div>
        ...
        {/* Mobile Navigation */}
          ...
          >
            <Link href="#features" className="block px-4 py-2 text-sm text-muted-foreground hover:text-foreground">
              Features
            </Link>
            ...
            <div className="pt-2 space-y-2">
              {(!initialized || !isAuthenticated) ? (
                <>
                  ...
                  <Link href="/auth/register" className="block w-full px-6 py-2 rounded-full bg-primary text-white text-sm font-medium hover:bg-primary/90 transition text-center">
                    Register
                  </Link>
                </>
              ) : (
