...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 my-10">
      <Card className="max-w-md w-full shadow-lg border border-gray-200 rounded-2xl overflow-hidden bg-white">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        disabled={isLoading}
                        className="bg-gray-50 border border-gray-300 focus:border-gray-500 focus:ring focus:ring-gray-200 text-gray-900"
                      />
                    </FormControl>
